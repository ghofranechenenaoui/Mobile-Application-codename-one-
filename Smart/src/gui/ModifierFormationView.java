...
public class ModifierFormationView {
    private Form parentForm;
    private Form form;
    private Formation exp;
    ...
    public ModifierFormationView(Form parentForm, Formation exp,int memberId){
     ...
     //   employeur = new TextField(exp.getEmployeur(), "employeur", 60, TextField.ANY);
        ...
        periode = new TextField(exp.getSpecialite(), "¨specialite", 60, TextField.ANY);
    ...
    private void buildContainer(){
        ...
        c.add(new Label("Specialite: ")).add(periode);
        ...
        submitButton.addActionListener((e) -> {
          //  if(checkFormValidity()){
                ...
                exp.setSpecialite(periode.getText());
                exp.setDescription(description.getText());
                
              
                
                
                FormationService.getInstance().editFormation(exp);
                Dialog.show("Formation modifieé", "Votre Formation est modifiée avec succés", "OK", "Cancel");
